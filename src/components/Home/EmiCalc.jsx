      ...
      <div className="py-10 px-4 max-w-6xl mx-auto">
        ...
        <div className="">
          ...
          <p className="mb-6">
            ...
            monthly installment on your home loan.
          </p>
          ...
          <ul className="list-disc ml-6 mb-4">
            <li className="mb-2">
              <strong>How much should you borrow?</strong> The calculator can
              help you decide the home loan amount, based on how much EMI you
              can afford to pay from your income. In other words, you can plan
              your finances better.
            </li>
            <li className="mb-2">
              <strong>How long should the tenure be?</strong> Knowing the EMI
              you can afford to pay every month, you can determine the right
              tenure for your loan.
            </li>
            <li className="mb-4">
              <strong>How much down payment should you make?</strong> Using the
              home loan EMI calculator, you can figure out how much you should
              pay as the down payment, in order to save the maximum on your
              interest while keeping your EMIs to a minimum.
            </li>
          </ul>
          ...
          <ul className="list-disc ml-6 mb-4">
            ...
            <li className="mb-2">
              ...
              EMI will be lower. Remember, a longer tenure also means you pay
              more interest over the period as compared to a shorter tenure
              loan.
            </li>
            <li className="mb-2">
          ...
          <ol className="list-decimal ml-6 mb-4 ">
            ...
            <li className="mb-2 flex">
              <FaMoneyBillWave className="mr-2" />
              <strong>Don't borrow more than you can afford.</strong> If you
              can't afford to repay on time, don't borrow.
            </li>
            <li className="mb-2 flex">
              <FaMoneyBillWave className="mr-2" />
